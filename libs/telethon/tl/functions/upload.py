...
class GetFileRequest(TLRequest):
    ...
    def to_dict(self):
        return {
            ...
            if isinstance(self.location, TLObject)
            else self.location,
            "offset": self.offset,
            "limit": self.limit,
    ...
    def _bytes(self):
        return b"".join(
            (
                ...
                struct.pack(
                    "<I",
                    (0 if self.precise is None or self.precise is False else 1)
                    | (
                        0
                        if self.cdn_supported is None or self.cdn_supported is False
                        else 2
                    ),
                ),
...
class SaveBigFilePartRequest(TLRequest):
    ...
    def from_reader(cls, reader):
        ...
        return cls(
            ...
            file_total_parts=_file_total_parts,
            bytes=_bytes,
        )
