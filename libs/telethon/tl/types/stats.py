...
class BroadcastStats(TLObject):
    ...
    def to_dict(self):
        return {
            ...
            if isinstance(self.period, TLObject)
            else self.period,
            "followers": self.followers.to_dict()
            if isinstance(self.followers, TLObject)
            else self.followers,
            "views_per_post": self.views_per_post.to_dict()
            if isinstance(self.views_per_post, TLObject)
            else self.views_per_post,
            "shares_per_post": self.shares_per_post.to_dict()
            if isinstance(self.shares_per_post, TLObject)
            else self.shares_per_post,
            "enabled_notifications": self.enabled_notifications.to_dict()
            if isinstance(self.enabled_notifications, TLObject)
            else self.enabled_notifications,
            "growth_graph": self.growth_graph.to_dict()
            if isinstance(self.growth_graph, TLObject)
            else self.growth_graph,
            "followers_graph": self.followers_graph.to_dict()
            if isinstance(self.followers_graph, TLObject)
            else self.followers_graph,
            "mute_graph": self.mute_graph.to_dict()
            if isinstance(self.mute_graph, TLObject)
            else self.mute_graph,
            "top_hours_graph": self.top_hours_graph.to_dict()
            if isinstance(self.top_hours_graph, TLObject)
            else self.top_hours_graph,
            "interactions_graph": self.interactions_graph.to_dict()
            if isinstance(self.interactions_graph, TLObject)
            else self.interactions_graph,
            "iv_interactions_graph": self.iv_interactions_graph.to_dict()
            if isinstance(self.iv_interactions_graph, TLObject)
            else self.iv_interactions_graph,
            "views_by_source_graph": self.views_by_source_graph.to_dict()
            if isinstance(self.views_by_source_graph, TLObject)
            else self.views_by_source_graph,
            "new_followers_by_source_graph": self.new_followers_by_source_graph.to_dict()
            if isinstance(self.new_followers_by_source_graph, TLObject)
            else self.new_followers_by_source_graph,
            "languages_graph": self.languages_graph.to_dict()
            if isinstance(self.languages_graph, TLObject)
            else self.languages_graph,
            "recent_message_interactions": []
            if self.recent_message_interactions is None
            else [
                x.to_dict() if isinstance(x, TLObject) else x
                for x in self.recent_message_interactions
            ],
        }
    ...
    def _bytes(self):
        return b"".join(
            (
                ...
                b"\x15\xc4\xb5\x1c",
                struct.pack("<i", len(self.recent_message_interactions)),
                b"".join(x._bytes() for x in self.recent_message_interactions),
            )
        )
    ...
    def from_reader(cls, reader):
        ...
        return cls(
            ...
            views_per_post=_views_per_post,
            shares_per_post=_shares_per_post,
            enabled_notifications=_enabled_notifications,
            growth_graph=_growth_graph,
            followers_graph=_followers_graph,
            mute_graph=_mute_graph,
            top_hours_graph=_top_hours_graph,
            interactions_graph=_interactions_graph,
            iv_interactions_graph=_iv_interactions_graph,
            views_by_source_graph=_views_by_source_graph,
            new_followers_by_source_graph=_new_followers_by_source_graph,
            languages_graph=_languages_graph,
            recent_message_interactions=_recent_message_interactions,
        )
...
class MegagroupStats(TLObject):
    ...
    def to_dict(self):
        return {
            ...
            if isinstance(self.members, TLObject)
            else self.members,
            "messages": self.messages.to_dict()
            if isinstance(self.messages, TLObject)
            else self.messages,
            "viewers": self.viewers.to_dict()
            if isinstance(self.viewers, TLObject)
            else self.viewers,
            "posters": self.posters.to_dict()
            if isinstance(self.posters, TLObject)
            else self.posters,
            "growth_graph": self.growth_graph.to_dict()
            if isinstance(self.growth_graph, TLObject)
            else self.growth_graph,
            "members_graph": self.members_graph.to_dict()
            if isinstance(self.members_graph, TLObject)
            else self.members_graph,
            "new_members_by_source_graph": self.new_members_by_source_graph.to_dict()
            if isinstance(self.new_members_by_source_graph, TLObject)
            else self.new_members_by_source_graph,
            "languages_graph": self.languages_graph.to_dict()
            if isinstance(self.languages_graph, TLObject)
            else self.languages_graph,
            "messages_graph": self.messages_graph.to_dict()
            if isinstance(self.messages_graph, TLObject)
            else self.messages_graph,
            "actions_graph": self.actions_graph.to_dict()
            if isinstance(self.actions_graph, TLObject)
            else self.actions_graph,
            "top_hours_graph": self.top_hours_graph.to_dict()
            if isinstance(self.top_hours_graph, TLObject)
            else self.top_hours_graph,
            "weekdays_graph": self.weekdays_graph.to_dict()
            if isinstance(self.weekdays_graph, TLObject)
            else self.weekdays_graph,
            "top_posters": []
            if self.top_posters is None
            else [
                x.to_dict() if isinstance(x, TLObject) else x for x in self.top_posters
            ],
            "top_admins": []
            if self.top_admins is None
            else [
                x.to_dict() if isinstance(x, TLObject) else x for x in self.top_admins
            ],
            "top_inviters": []
            if self.top_inviters is None
            else [
                x.to_dict() if isinstance(x, TLObject) else x for x in self.top_inviters
            ],
            "users": []
    ...
    def _bytes(self):
        return b"".join(
            (
                ...
                b"\x15\xc4\xb5\x1c",
                struct.pack("<i", len(self.top_posters)),
                b"".join(x._bytes() for x in self.top_posters),
                b"\x15\xc4\xb5\x1c",
                struct.pack("<i", len(self.top_admins)),
                b"".join(x._bytes() for x in self.top_admins),
                b"\x15\xc4\xb5\x1c",
                struct.pack("<i", len(self.top_inviters)),
                b"".join(x._bytes() for x in self.top_inviters),
                b"\x15\xc4\xb5\x1c",
    ...
    def from_reader(cls, reader):
        ...
        return cls(
            ...
            posters=_posters,
            growth_graph=_growth_graph,
            members_graph=_members_graph,
            new_members_by_source_graph=_new_members_by_source_graph,
            languages_graph=_languages_graph,
            messages_graph=_messages_graph,
            actions_graph=_actions_graph,
            top_hours_graph=_top_hours_graph,
            weekdays_graph=_weekdays_graph,
            top_posters=_top_posters,
            top_admins=_top_admins,
            top_inviters=_top_inviters,
            users=_users,
        )
...
class MessageStats(TLObject):
    ...
    def to_dict(self):
        return {
            "_": "MessageStats",
            "views_graph": self.views_graph.to_dict()
            if isinstance(self.views_graph, TLObject)
            else self.views_graph,
        }
