...
class AppUpdate(TLObject):
    ...
    def __init__(
        ...
        can_not_skip: Optional[bool] = None,
        ...
        return b"".join(
            (
                ...
                struct.pack(
                    ...
                    (
                        0
                        if self.can_not_skip is None or self.can_not_skip is False
                        else 1
                    )
                    | (0 if self.document is None or self.document is False else 2)
    ...
    def to_dict(self):
        return {
            ...
            if self.countries is None
                ...
                x.to_dict() if isinstance(x, TLObject) else x for x in self.countries
            ],
            "hash": self.hash,
        }
    ...
    def _bytes(self):
        return b"".join(
            (
                b"\x9eu\xd0\x87",
                b"\x15\xc4\xb5\x1c",
                struct.pack("<i", len(self.countries)),
                b"".join(x._bytes() for x in self.countries),
...
class CountriesListNotModified(TLObject):
    ...
    def to_dict(self):
        return {"_": "CountriesListNotModified"}

    def _bytes(self):
        return b"".join((b"2\x1f\xcc\x93",))
    ...
    def _bytes(self):
        return b"".join(
            (
                ...
                struct.pack(
                    "<I",
                    (0 if self.hidden is None or self.hidden is False else 1)
                    | (0 if self.name is None or self.name is False else 2),
                ),
                self.serialize_bytes(self.iso2),
                self.serialize_bytes(self.default_name),
                b""
                if self.name is None or self.name is False
                else (self.serialize_bytes(self.name)),
                b"\x15\xc4\xb5\x1c",
                struct.pack("<i", len(self.country_codes)),
                b"".join(x._bytes() for x in self.country_codes),
            )
        )
    ...
    def _bytes(self):
        return b"".join(
            (
                ...
                struct.pack(
                    "<I",
                    (0 if self.prefixes is None or self.prefixes is False else 1)
                    | (0 if self.patterns is None or self.patterns is False else 2),
                ),
                self.serialize_bytes(self.country_code),
                b""
                if self.prefixes is None or self.prefixes is False
                else b"".join(
                    (
                        b"\x15\xc4\xb5\x1c",
                        struct.pack("<i", len(self.prefixes)),
                        b"".join(self.serialize_bytes(x) for x in self.prefixes),
                    )
                ),
                b""
                if self.patterns is None or self.patterns is False
                else b"".join(
                    (
                        b"\x15\xc4\xb5\x1c",
                        struct.pack("<i", len(self.patterns)),
                        b"".join(self.serialize_bytes(x) for x in self.patterns),
                    )
                ),
            )
        )
    ...
    def _bytes(self):
        return b"".join(
            (
                ...
                struct.pack(
                    "<I",
                    (0 if self.update_app is None or self.update_app is False else 1)
                    | (0 if self.entities is None or self.entities is False else 2),
                ),
...
class DeepLinkInfoEmpty(TLObject):
    ...
    def to_dict(self):
        return {"_": "DeepLinkInfoEmpty"}

    def _bytes(self):
        return b"".join((b"f\xa1\xaff",))
...
class InviteText(TLObject):
    ...
    def to_dict(self):
        return {"_": "InviteText", "message": self.message}
...
class PassportConfig(TLObject):
    ...
    def to_dict(self):
        return {
            "_": "PassportConfig",
            "hash": self.hash,
            "countries_langs": self.countries_langs.to_dict()
            if isinstance(self.countries_langs, TLObject)
            else self.countries_langs,
        }
...
class PassportConfigNotModified(TLObject):
    ...
    def to_dict(self):
        return {"_": "PassportConfigNotModified"}

    def _bytes(self):
        return b"".join((b"W\xf4\xb9\xbf",))
        ...
        return b"".join(
            (
                ...
                struct.pack(
                    ...
                    | (0 if self.psa_type is None or self.psa_type is False else 2)
                    | (
                        0
                        if self.psa_message is None or self.psa_message is False
                        else 4
                    ),
                ),
                self.serialize_datetime(self.expires),
                ...
                b""
                if self.psa_type is None or self.psa_type is False
                else (self.serialize_bytes(self.psa_type)),
                b""
                if self.psa_message is None or self.psa_message is False
                else (self.serialize_bytes(self.psa_message)),
            )
        )
...
class PromoDataEmpty(TLObject):
    ...
    def to_dict(self):
        return {"_": "PromoDataEmpty", "expires": self.expires}
...
class RecentMeUrls(TLObject):
    ...
    def to_dict(self):
        return {
            ...
            else [x.to_dict() if isinstance(x, TLObject) else x for x in self.urls],
            "chats": []
            if self.chats is None
            else [x.to_dict() if isinstance(x, TLObject) else x for x in self.chats],
            "users": []
    ...
    def _bytes(self):
        return b"".join(
            (
                b"\xd7\x10\x03\x0e",
                b"\x15\xc4\xb5\x1c",
                struct.pack("<i", len(self.urls)),
                b"".join(x._bytes() for x in self.urls),
                b"\x15\xc4\xb5\x1c",
                struct.pack("<i", len(self.chats)),
                b"".join(x._bytes() for x in self.chats),
                b"\x15\xc4\xb5\x1c",
...
class SupportName(TLObject):
    ...
    def to_dict(self):
        return {"_": "SupportName", "name": self.name}
...
class TermsOfService(TLObject):
    ...
    def _bytes(self):
        return b"".join(
            (
                ...
                struct.pack(
                    "<I",
                    (0 if self.popup is None or self.popup is False else 1)
                    | (
                        0
                        if self.min_age_confirm is None or self.min_age_confirm is False
                        else 2
                    ),
                ),
                self.id._bytes(),
                ...
                b""
                if self.min_age_confirm is None or self.min_age_confirm is False
                else (struct.pack("<i", self.min_age_confirm)),
            )
        )
    ...
    def from_reader(cls, reader):
        ...
        return cls(
            ...
            entities=_entities,
            popup=_popup,
            min_age_confirm=_min_age_confirm,
        )
...
class TermsOfServiceUpdate(TLObject):
    ...
    def __init__(
        self, expires: Optional[datetime], terms_of_service: "TypeTermsOfService"
    ):
        """
...
class TermsOfServiceUpdateEmpty(TLObject):
    ...
    def to_dict(self):
        return {"_": "TermsOfServiceUpdateEmpty", "expires": self.expires}
...
class UserInfoEmpty(TLObject):
    ...
    def to_dict(self):
        return {"_": "UserInfoEmpty"}

    def _bytes(self):
        return b"".join((b"\xed.\xae\xf3",))
